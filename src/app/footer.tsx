export default async function Footer() {
    ...
    <div>
        <div className="flex bg-[#103C42] *:text-white">
            <div className="p-16 pl-32 flex flex-row">
            ...
            <div className="flex flex-col space-y-6 pt-20 p-10 pl-20">
                ...
                <div className="flex flex-col space-y-3">
                    <a className="underline hover:text-gray-500 transition duration-150 ease-in-out hover:no-underline flex">
                        <img className="w-5 h-5 mr-3" src="/footer/email.png"></img>
                        Email
                    </a>
            ...
            <div className="pl-20 *:text-center">
                <div className="bg-[#005F65] m-10 flex flex-col items-center justify-center rounded-lg border-white border-4 shadow-lg">
                    ...
                    <div className="relative group">
                        <input placeholder="Email Address" className="p-3 rounded-lg text-black w-5/6 mb-5 group"></input>
                        <button className="absolute text-black right-7 top-3 invisible group-focus-within:visible"><img src="/footer/rarrow.png" className="w-5 h-5"></img></button>
                    </div>
                </div>
            </div>
        </div>
